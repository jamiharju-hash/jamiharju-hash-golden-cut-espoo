...
const haircutServices = [
  {
    name: "Klassinen leikkaus",
    desc: "Perinteinen kone- tai saksileikkaus siisteillä linjoilla.",
    price: "20 €",
  },
  {
    name: "Skin fade",
    desc: "Moderni ja tarkka häivytys nollasta ylöspäin.",
    price: "20 €",
  },
  {
    name: "Mid fade / Taper fade",
    desc: "Luonnollinen ja helposti ylläpidettävä fade.",
    price: "20 €",
  },
  {
    name: "Lasten leikkaus",
    desc: "Rento ja nopea leikkaus perheen pienimmille.",
    price: "kysy",
  },
];
...
const beardServices = [
  {
    ...
    desc: "Linjojen siistiminen ja muodon hakeminen.",
    price: "15 €",
  },
  {
    name: "Koneajo",
    desc: "Nopea ja tarkka lyhennys koneella.",
    price: "10 €",
  },
  {
    name: "Hiukset + parta",
    desc: "Kokonaisuus, jossa leikkaus ja parta viimeistellään samalla käynnillä.",
    price: "35 €",
  },
];
...
function LocationCta({
  ...
  label?: "Tule ilman ajanvarausta" | "Katso sijainti" | "Tule käymään";
  source: string;
  className?: string;
}) {
  return (
    ...
    <section id="etusivu" className="relative min-h-[100svh] overflow-hidden bg-black px-4 pb-24 pt-24 min-[380px]:px-5 min-[380px]:pt-28 sm:px-6 sm:pb-16 sm:pt-32 lg:px-8 2xl:px-12">
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh-6rem)] max-w-[100rem] flex-col justify-end sm:min-h-[calc(100vh-8rem)]">
        <motion.div initial="hidden" animate="visible" variants={reveal} className="max-w-6xl 2xl:max-w-7xl">
          ...
          <h1 className="font-display max-w-[9.2ch] text-[14vw] font-black leading-[0.9] tracking-[-0.08em] text-white drop-shadow-[0_20px_70px_rgba(0,0,0,0.75)] sm:text-[72px] lg:text-[127px] 2xl:max-w-[10ch]">
    ...
    <section id="kuvat" className="bg-black px-4 py-20 min-[380px]:px-5 sm:px-6 sm:py-24 lg:px-8 2xl:px-12">
      <motion.div variants={reveal} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} className="mx-auto max-w-[100rem]">
        ...
        <a href={heroPhoto.sourceUrl} target="_blank" rel="noreferrer" onClick={() => trackMaps("gallery_photo")} className="editorial-image-zoom relative mt-10 block overflow-hidden border border-white/10 bg-black sm:mt-12">
          ...
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.18)_0%,rgba(0,0,0,0.62)_100%)]" />
        </a>
      </motion.div>
    </section>
  );
    ...
    <footer id="sijainti" className="bg-[#0D0D0D] px-4 py-16 pb-32 min-[380px]:px-5 sm:px-6 sm:py-20 lg:px-8 2xl:px-12">
      <div className="mx-auto max-w-[100rem]">
        ...
        <div className="mt-12 sm:mt-16">
          <LocationCta source="footer_primary_location" label="Tule ilman ajanvarausta" className="w-full sm:w-full" />
        </div>
